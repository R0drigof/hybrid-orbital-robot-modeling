...
def shooting(nn_model, t, t_np, positions, velocities, ang_v, quaternions, actuation, just_last_sample, rtol_aux, atol_aux, shooting_time, hparam_pos, hparam_vel, hparam_quat, hparam_ang_v, t_separation, physical_params):
...
def plot_shooting_results_rmse(datasets_vec, plot_select_data_vec, plot_t_select_data_initial_vec, plot_t_select_data_final_vec, plot_t_u_flag_vec, plot_t_u_before_vec, plot_t_u_after_vec, nn_model, hparam_pos, hparam_vel, hparam_quat, hparam_ang_v, pred_samples_factor, shooting_time, just_last_sample, rtol_aux, atol_aux, file, directory1, directory2, directory3, num_epochs, lr, optimizer, flag_scheduler, str_t_u_flag, folder_gimble, physical_params):
    ...
    for i in range(len(datasets_vec)):
        ...
        # Shooting
        loss,pred_positions,pred_velocities,pred_quaternions,pred_ang_v,_ = shooting(nn_model, t, t_np, positions, velocities, ang_v, quaternions, actuation, just_last_sample, rtol_aux, atol_aux, shooting_time, hparam_pos, hparam_vel, hparam_quat, hparam_ang_v, t_separation, physical_params)
...
if __name__ == "__main__":
    ...
    for epoch in range(num_epochs):
        ...
        total_loss,_,_,_,_,odeint_time = shooting(nn_model, t, t_np, positions, velocities, ang_v, quaternions, actuation, just_last_sample, rtol_aux, atol_aux, shooting_time, hparam_pos, hparam_vel, hparam_quat, hparam_ang_v, t_separation, physical_params)
    ...
    final_loss,_,_,_,_,_ = shooting(nn_model, t, t_np, positions, velocities, ang_v, quaternions, actuation, just_last_sample, rtol_aux, atol_aux, shooting_time, hparam_pos, hparam_vel, hparam_quat, hparam_ang_v, t_separation, physical_params)
